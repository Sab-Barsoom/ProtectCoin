...
// Copyright (c) 2020, The ProtectCoin Developers
//
...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x10ac88;

        const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW = 40;  //30 minutes
        ...
        const uint32_t ZAWY_DIFFICULTY_BLOCK_INDEX = 187000; //187000
...
"";
...
/*"010a01ff000188f3b501029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd088071210142694232c5b04151"
        ...
        const uint64_t GENESIS_BLOCK_TIMESTAMP = 1601447601;
        ...
        const uint32_t UPGRADE_HEIGHT_V3 = 2; //  Upgrade height for CN-Lite Variant 0 switch.

        const uint32_t UPGRADE_HEIGHT_V4 = 350000; // Upgrade height for CN Dark Variant 1 switch.

        const uint32_t UPGRADE_HEIGHT_V5 = 1200000; // Upgrade height for CN-Turtle Variant 2 switch.

        const uint32_t UPGRADE_HEIGHT_V6 = 3000000; // Upgrade height for Chukwa switch.
    ...
    const std::unordered_map<uint8_t, std::function<void(const void *data, size_t length, Crypto::Hash &hash)>>
        HASHING_ALGORITHMS_BY_BLOCK_VERSION = {
            ...
            {BLOCK_MAJOR_VERSION_3, Crypto::cn_lite_slow_hash_v0}, /* UPGRADE_HEIGHT_V3 */
            {BLOCK_MAJOR_VERSION_4, Crypto::cn_dark_slow_hash_v0}, /* UPGRADE_HEIGHT_V4 */
    ...
    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb5, 0x0c, 0x4a, 0x6c, 0xcf, 0x52, 0x57, 0x41, 0x65, 0xf9, 0x91, 0xa4, 0xb6, 0xc1, 0x43, 0x43}}; // {0xb5, 0x0c, 0x4a, 0x6c, 0xcf, 0x52, 0x57, 0x41, 0x65, 0xf9, 0x91, 0xa4, 0xb6, 0xc1, 0x43, 0xe9}
